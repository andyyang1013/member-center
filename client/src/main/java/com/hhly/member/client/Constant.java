...
//    public static String BASE_DOMAIN = "http://10.41.12.85:9902";
    public static String BASE_DOMAIN = "http://10.41.12.89:9902";
...
//    public static String BASE_DOMAIN = "http://umcapi.zcopain.com";
     ...
     */
    public static String QUERY_BY_ID_URL = BASE_URL+"/api/queryUserInfoById";
     ...
     * 根据token获取当前登录的用户信息
     */
    public static String GET_CUR_LOGIN_USER_URL = BASE_URL+"/api/getCurLoginUser";
     ...
     * 重置密码（根据手机号码）
     */
    public static String ACCOUNT_RESET_PASSWORD_BY_PHONE = BASE_URL + "/api/account/resetPassByPhone";

    /**
     * 重置密码（根据邮箱）
     */
    public static String ACCOUNT_RESET_PASSWORD_BY_EMAIL = BASE_URL + "/api/account/resetPassByEmail";
    ...
    public static void setEnvInfo(String domain,String apiKey,String apiSecret){
        ...
        QUERY_BY_ID_URL = BASE_URL+"/api/queryUserInfoById";
        ...
        GET_CUR_LOGIN_USER_URL = BASE_URL+"/api/getCurLoginUser";
        ...
        ACCOUNT_RESET_PASSWORD_BY_PHONE = BASE_URL + "/api/account/resetPassByPhone";

        ACCOUNT_RESET_PASSWORD_BY_EMAIL = BASE_URL + "/api/account/resetPassByEmail";
    }
